  ...
  return (
    <div className="min-h-screen flex items-center justify-center">
      <motion.svg
        ...
        className="h-36 w-36 stroke-neutral-500 [--fill-final:var(--color-yellow-300)] [--fill-initial:var(--color-neutral-50)] dark:stroke-neutral-100 dark:[--fill-final:var(--color-yellow-500)] dark:[--fill-initial:var(--color-neutral-800)]"
      >
      ...
      <span className="mt-4 text-lg font-semibold text-neutral-700 dark:text-neutral-300">
